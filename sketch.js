...
function preload()
{
  ...
  happyDog = loadImage("images/dogImg.jpg");

  normalDog = loadImage("images/dogImg1.jpg");

  sleepyDog = loadImage("images/Bed Room.jpg");

  bathroom = loadImage("images/Wash Room.jpg");

  living = loadImage("images/Play .jpg")
}
